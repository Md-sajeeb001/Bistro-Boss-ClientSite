//*
// **
// ** 1.install strip and strip react 
// ** 2.create card element
// ** 3.crate strip account and get published key
// ** 4.use published key and use stripe te get card information error 
// *  5.create payment intent post on the server and return client sercet.
